...
-   *length* -- średnią długość przedziału ufności,
...
Przy wykorzystaniu funkcji *sprawdzaj_CI_exact*, naniesiono na wykres średnią długość przedziału ufności w zależności od *p* dla wszytskich badanych metod oraz wartości *n*.
