...
```{r}
ankieta <- read.csv('/Users/joannakusy/pwr/rok3/analiza_danych_ankietowych/ankieta.csv', 
...
```{r}
# check if column contains valid values
...
```{r, echo=FALSE}
p2 <- ggplot(ankieta, aes(x=PYT_2, fill=PYT_2)) + geom_bar(color='white') + labs(title='Pytanie 2', fill='Odpowiedzi') 
p2
```
